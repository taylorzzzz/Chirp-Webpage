	...
	function cpotheme_custom_form( $option_name, $option_list ) {
		...
		<div class="wrap">
			<div class="cpothemes-version">
				...
				<span><a href="http://cpothemes.com/documentation?utm_source=theme%20settings&utm_medium=options&utm_campaign=themes" target="_blank"><?php _e( 'Help', 'cpotheme' ); ?></a></span>
			</div>
	...
	function cpotheme_custom_header() {
		...
		<div class="cpothemes-header">
			...
			<div class="cpothemes-header-meta">
				<a target="_blank" href="http://www.cpothemes.com/support"><?php _e( 'Theme Documentation', 'cpotheme' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://themeforest.net/user/cpothemes?ref=cpothemes"><?php _e( 'More Themes', 'cpotheme' ); ?></a>
			</div>
		</div>
...
if ( ! function_exists( 'cpotheme_custom_support' ) ) {
	function cpotheme_custom_support() {
		...
		$output .= '<a target="_blank" href="http://www.cpothemes.com/documentation">' . __( 'Theme Documentation', 'cpotheme' ) . '</a>';
		$output .= '&nbsp;&nbsp;|&nbsp;&nbsp;';
		$output .= '<a target="_blank" href="http://www.cpothemes.com/forums">' . __( 'Support Forum', 'cpotheme' ) . '</a>';
		$output .= '</div>';
		return $output;
	}
}
	...
	function cpotheme_custom_header_old() {
		...
		<div class="cpotheme-header">
			...
			<div class="header-meta">
				<a target="_blank" href="http://www.cpothemes.com/support"><?php _e( 'Theme Documentation', 'cpotheme' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://www.cpothemes.com/forums"><?php _e( 'Support Forums', 'cpotheme' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://www.cpothemes.com/themes"><?php _e( 'More Themes', 'cpotheme' ); ?></a>
			</div>
		</div>
