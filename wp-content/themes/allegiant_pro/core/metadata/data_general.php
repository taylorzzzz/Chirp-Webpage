...
if ( ! function_exists( 'cpotheme_metadata_fonts' ) ) {
	function cpotheme_metadata_fonts( $key = null ) {
		$cpotheme_data = array(
			'(Standard)'      => array(
				'name' => __( 'Standard Fonts', 'cpotheme' ),
				'type' => 'separator',
			),
			'Arial'           => 'Arial',
			'Georgia'         => 'Georgia',
			...
			'(Sans Serif)'          => array(
				'name' => __( 'Sans Serif Fonts', 'cpotheme' ),
				'type' => 'separator',
			),
			'ABeeZee'               => 'ABeeZee',
			'Abel'                  => 'Abel',
			...
			'(Display)'           => array(
				'name' => __( 'Display Fonts', 'cpotheme' ),
				'type' => 'separator',
			),
			'Allan'               => 'Allan',
			'Amarante'            => 'Amarante',
			...
			'(Handwriting)'           => array(
				'name' => __( 'Handwritten Fonts', 'cpotheme' ),
				'type' => 'separator',
			),
			'Allura'                  => 'Allura',
			'Arizonia'                => 'Arizonia',
...
function cpotheme_metadata_slider_effect() {
	$cpotheme_data = array(
		'fade'      => esc_html__( 'Fade', 'cpotheme' ),
		'flipHorz'  => esc_html__( 'Horizontal Flip', 'cpotheme' ),
		'flipVert'  => esc_html__( 'Vertical Flip', 'cpotheme' ),
		'shuffle'   => esc_html__( 'Shuffle', 'cpotheme' ),
		'tileSlide' => esc_html__( 'Tile Slide', 'cpotheme' ),
		'tileBlind' => esc_html__( 'Tile Blind', 'cpotheme' ),
	);
...
function cpotheme_metadata_homepage_order() {
	...
	if ( defined( 'CPOTHEME_USE_PRODUCTS' ) && CPOTHEME_USE_PRODUCTS == true ) {
		$data['products'] = __( 'Products', 'cpotheme' );
	}
	...
	$data['content'] = __( 'Page Contents', 'cpotheme' );
...
if ( ! function_exists( 'cpotheme_metadata_post_preview' ) ) {
	function cpotheme_metadata_post_preview() {
		$cpotheme_data = array(
			'excerpt' => __( 'Show Excerpt', 'cpotheme' ),
			'full'    => __( 'Show Full Content', 'cpotheme' ),
			'none'    => __( 'Do Not Show', 'cpotheme' ),
		);
...
if ( ! function_exists( 'cpotheme_metadata_post_layout' ) ) {
	function cpotheme_metadata_post_layout() {
		$cpotheme_data = array(
			'vertical'   => __( 'Vertical', 'cpotheme' ),
			'horizontal' => __( 'Horizontal', 'cpotheme' ),
		);
...
if ( ! function_exists( 'cpotheme_metadata_social_profiles' ) ) {
	function cpotheme_metadata_social_profiles() {
		$cpotheme_data = array(
			'name' => array(
				'label' => __( 'Name', 'cpotheme' ),
				'width' => '75',
				'args'  => array( 'placeholder' => 'Profile Name' ),
			),
			'icon' => array(
				'label'  => __( 'Icon', 'cpotheme' ),
				'width'  => '25',
				'type'   => 'select',
