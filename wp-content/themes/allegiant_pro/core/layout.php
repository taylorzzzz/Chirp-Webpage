...
function cpotheme_styling_css() {
	...
	$color_headings = apply_filters( 'cpotheme_color_headings', cpotheme_get_option( 'type_headings_color' ) );
	$color_widgets  = apply_filters( 'cpotheme_color_widgets', cpotheme_get_option( 'type_widgets_color' ) );
	$color_nav      = apply_filters( 'cpotheme_color_menu', cpotheme_get_option( 'type_nav_color' ) );
	$color_body     = apply_filters( 'cpotheme_color_body', cpotheme_get_option( 'type_body_color' ) );
	$color_links    = apply_filters( 'cpotheme_color_links', cpotheme_get_option( 'type_link_color' ) );
	...
	<style type="text/css">
		...
		<?php if ( $color_headings == $defaults['type_headings_color']['default'] ) { ?>
...
function cpotheme_init_sidebar() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Default Widgets', 'cpotheme' ),
			'id'            => 'primary-widgets',
	...
	register_sidebar(
		array(
			'name'          => __( 'Secondary Widgets', 'cpotheme' ),
