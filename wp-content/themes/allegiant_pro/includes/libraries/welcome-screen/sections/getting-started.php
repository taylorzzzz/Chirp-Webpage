...
<div class="feature-section three-col">
	<div class="col">
		...
		<?php if ( $count == 0 ) { ?>
			<p><span class="dashicons dashicons-yes"></span>
				<a href="<?php echo admin_url( 'themes.php?page=allegiant_pro-welcome&tab=recommended-actions' ); ?>"><?php esc_html_e( 'No recommended actions left to perform', 'allegiant' ); ?></a>
			</p>
		<?php } else { ?>
			<p><span class="dashicons dashicons-no-alt"></span> <a href="<?php echo admin_url( 'themes.php?page=allegiant_pro-welcome&tab=recommended-actions' ); ?>"><?php esc_html_e( 'Check recommended actions', 'allegiant' ); ?></a>
			</p> 
			<?php
};
		?>
	...
	<div class="col">
		...
		<p>
			<a target="_blank"
			   href="<?php echo esc_url( 'https://cpothemes.com/documentation?utm_source=allegiant-pro&utm_medium=about-page&utm_campaign=docs-button' ); ?>"><?php esc_html_e( 'Full documentation', 'allegiant' ); ?></a>
		</p>
	</div><!--/.col-->
