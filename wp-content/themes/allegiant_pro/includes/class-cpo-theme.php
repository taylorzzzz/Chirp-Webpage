...
class CPO_Theme {
	...
	function __construct() {
		...
		$this->actions = array(
			$actions[] = array(
				'id'          => 'allegiant-pro-req-ac-import-demo-content',
				'title'       => esc_html__( 'Import Demo Content', 'allegiant' ),
				'description' => esc_html__( 'Clicking the button below will add content, widgets and set static front page to your WordPress installation. Click advanced to customize the import process. This procces might take up to 2 min. Please don\'t close the window.', 'allegiant' ),
	...
	public function import_option() {
		return 'allegiant_pro_content_imported';
	}
